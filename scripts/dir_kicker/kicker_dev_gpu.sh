...
singularity run  --home ~/jupyter_notebook/user_work/tcrpred/:/root/jupyter_notebook/user_work/tcrpred/ --nv /sqfs/work/K2107/u6b233/nvidia_sandbox.sif /usr/bin/python scripts/main.py --dev --params optuna_best.json --dataset mcpas
